      ...
      <div className="grid md:grid-cols-12 gap-10">
        <div className="hidden md:block md:col-span-4 lg:col-span-3 shadow-lg h-fit sticky top-10 bg-[#eff0f2] text-black dark:bg-[#21242A] dark:text-[#eff0f2] rounded-lg px-6 py-4">
          ...
          <div className="font-normal py-4 text-left">
            <h6 className="text-lg font-bold pb-3">About</h6>
        ...
        <div className="md:col-span-8 lg:col-span-9">
          ...
          <nav className="top-0 px-2 w-fit mx-auto md:w-full md:px-5 py-3 mb-8 text-gray-700 border-gray-200 rounded-lg bg-gray-50 dark:bg-[#21242A] dark:text-[#eff0f2] mt-7">
            <ol
              className={`${currentNav === 'bookings' ? 'text-tertiary-dark' : 'text-primary'} inline-flex mr-1 md:mr-5 items-center space-x-1 md:space-x-3`}
            >
              <li
            ...
            <ol
              className={`${currentNav === 'amount' ? 'text-tertiary-dark' : 'text-primary'} inline-flex mr-1 md:mr-5 items-center space-x-1 md:space-x-3`}
            >
              <li
