      ...
      {showModal && (
        <div className="fixed top-0 w-full h-full flex justify-center items-center bg-black bg-opacity-90 z-[55]">
          <div className="h-[75vh] w-[320px] md:w-[700px] relative">
            <Image
              src={photos[currentPhotoIndex].url}
              alt={`Room Poto ${currentPhotoIndex + 1}`}
              width={400}
              height={400}
              className="img"
            />
            ...
            <div className="flex justify-between items-center py-3">
              <div className="flex space-x-2 items-center text-tertiary-dark">
                <FaArrowLeft
                  className="cursor-pointer"
                  onClick={handlePrevious}
                />
            ...
            <button
              className="absolute top-2 right-2 text-tertiary-dark text-lg"
              onClick={closeModal}
            >
