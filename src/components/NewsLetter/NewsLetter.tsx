const NewsLetter = () => {
  return (
    <section>
      <form className="bg-primary text-white px-4 flex flex-col justify-center items-center py-6 md:py-24">
        <p className="md:font-semibold font-medium text-2xl md:text-3xl lg:text-5xl text-center mb-3">
