  ...
  return (
    <div className="overflow-x-auto max-w-[340px] rounded-lg mx-auto md:max-w-full shadow-md sm:rounded-lg">
      <table className="w-full text-sm text-left text-gray-500">
        <thead className="text-sm text-gray-700 uppercase bg-gray-50 dark:bg-[#1B1A1B] dark:text-[#eff0f2]">
          <tr>
        ...
        <tbody>
          {bookingDetails.map((booking) => (
            <tr
              key={booking._id}
              className="bg-white border-b hover:bg-gray-50 dark:bg-[#21242A] dark:text-[#eff0f2]"
            >
              <th
                onClick={() =>
